...
.. figure:: figs/coarsening_plopm.png

    Figure 1: Example of coarser models from a grid with 18 cells, where the cell #11 is inactive. 
    One application where the max option could be useful is for models where there are a lot of 
...
.. tip::
    ...
    The figure can be generated by executing in the terminal (`docs_theory_coarsening.sh <https://github.com/cssr-tools/pycopm/blob/main/tests/scripts/docs_theory_coarsening.sh>`_):
