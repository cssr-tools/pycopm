...
Finally, the utils folder contains different Python functions used in the framework for the 
grid refinement, grid coarsening, submodels, and transformations.
